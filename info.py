...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Filter:asmovie@filter.xm5hzyh.mongodb.net/?retryWrites=true&w=majority&appName=Filter")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Cinema_group_request')
